// ARK (AMD Root Key) - Self-signed root certificate, CN=ARK-Genoa
export const ARK_CERT = `-----BEGIN CERTIFICATE-----
...
// ASK (AMD SEV Key) - Intermediate certificate signed by ARK, CN=SEV-Genoa
export const ASK_CERT = `-----BEGIN CERTIFICATE-----
